...
- **Private functions:** `validate_address_lens` (L242), `validate_social_ids` (L287), `validate_phone_number` (L329), `row_to_identity` (L322), `validate_new_contact` (L326), `try_parse_dmr_subscriber_id` (L566), `validate_contact_update` (L654)
